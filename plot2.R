...
## Generate list of 2 days in minutes
## Not quite sure if all observations are there..
## Skipping to next line
## dd <- seq(as.POSIXct("2007-02-01 00:00:00"),by="min",length.out=2880) ## 60x24x2
...
## Plot
with(final, plot(datetime, Global_active_power, xlab = "",ylab = "Global Active Power (kilowatts)", type = "l"))
dev.off()